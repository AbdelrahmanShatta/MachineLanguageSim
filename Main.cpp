...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "Please choose the operation : " << endl
             << "1 - print out the current memory" << endl
             << "2 - print out the current register" << endl
             << "3 - Run the program with the current loaded txt file " << endl
             << "4 - Terminate the code" << endl;
        cin >> x;
